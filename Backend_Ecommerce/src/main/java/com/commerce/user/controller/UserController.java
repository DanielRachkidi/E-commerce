...
public class UserController
{
  ...
  public ResponseEntity<UserPayment> getUserPayment(@PathVariable (value = "userId") int userId) throws ResourceNotFoundException {
    User user = userService.findById(userId)
      .orElseThrow(() -> new ResourceNotFoundException("User not found for this id: " + userId));
  ...
  public ResponseEntity<UserInfo> getUserInfo(@PathVariable int userId) throws ResourceNotFoundException {
    User user = userService.findById(userId)
      .orElseThrow(() -> new ResourceNotFoundException("User not found for this id: " + userId));
